...
export function CartProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <CartContext.Provider value={value}>
      <style jsx global>{`.siteHeaderActions{display:flex;align-items:center;gap:.6rem;flex-wrap:wrap}.accountNavButton{display:inline-flex;align-items:center;gap:.35rem;border-radius:999px;padding:.44rem .75rem;color:#111827;text-decoration:none;font-weight:850}.accountNavButton:hover{background:#f8fafc;color:#4338ca}.cartNavButton,.floatingCartButton{border:0;border-radius:999px;background:linear-gradient(135deg,#4338ca,#10b981);color:#fff;font-weight:900;cursor:pointer}.cartNavButton{padding:.44rem .85rem;font-size:.88rem}.floatingCartButton{position:fixed;right:16px;bottom:16px;z-index:80;padding:.86rem 1rem;box-shadow:0 22px 45px -25px rgba(15,23,42,.9)}.cartOverlay{position:fixed;inset:0;background:rgba(15,23,42,.42);z-index:90;display:flex;justify-content:flex-end;overflow:hidden}.cartDrawer{width:min(100%,440px);height:100%;height:100dvh;max-height:100dvh;background:#fff;box-shadow:-30px 0 70px -48px rgba(15,23,42,.9);padding:18px;display:flex;flex-direction:column;gap:14px;overflow-y:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch}.cartDrawerHeader{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;border-bottom:1px solid #e2e8f0;padding-bottom:12px;position:sticky;top:0;z-index:4;background:#fff;flex:0 0 auto}.cartDrawerHeader h2,.cartDrawerHeader p{margin:0}.cartDrawerHeader p{color:#64748b;font-size:.88rem}.cartDrawerHeader button{border:1px solid #cbd5e1;background:#fff;border-radius:999px;width:34px;height:34px;font-weight:900;cursor:pointer}.cartDrawerBody{overflow:visible;display:grid;gap:12px;flex:0 0 auto}.cartLine{border:1px solid #e2e8f0;border-radius:16px;padding:12px;background:#f8fafc;display:grid;gap:8px}.cartLine p{margin:.2rem 0 0;color:#64748b;font-size:.85rem}.cartQty{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.cartQty button{border:1px solid #cbd5e1;background:#fff;border-radius:10px;padding:.35rem .55rem;font-weight:800;cursor:pointer}.cartCheckoutForm{display:grid;gap:8px;border-top:1px solid #e2e8f0;padding-top:12px;padding-bottom:calc(12px + env(safe-area-inset-bottom));flex:0 0 auto}.cartCheckoutForm input,.cartCheckoutForm textarea{border:1px solid #cbd5e1;border-radius:12px;padding:.68rem .75rem;font:inherit;width:100%}.cartCheckoutForm>button,.cartPrimaryPayLink{border:0;border-radius:14px;padding:.78rem 1rem;color:#fff;background:linear-gradient(135deg,#4338ca,#10b981);font-weight:900;text-align:center;text-decoration:none}.cartCheckoutForm>button{cursor:pointer}.cartCheckoutForm>button:disabled{opacity:.65;cursor:not-allowed}.cartCheckoutLinks{display:grid;gap:8px}.cartCheckoutLinks a{display:block;text-align:center;border-radius:12px;padding:.65rem .8rem;color:#fff;background:#4338ca;text-decoration:none;font-weight:850}.deliveryNotice{border:1px solid #fed7aa;background:#fff7ed;border-radius:14px;padding:.75rem;color:#7c2d12;font-size:.82rem;line-height:1.45}.deliveryNotice strong{display:block;color:#9a3412;margin-bottom:.25rem}.deliveryAck{display:flex;align-items:flex-start;gap:.5rem;border:1px solid #bfdbfe;background:#eff6ff;border-radius:14px;padding:.75rem;color:#1e3a8a;font-size:.8rem;line-height:1.45;font-weight:700}.deliveryAck input{width:auto;margin-top:.15rem}body:has(.cartOverlay) .marketLiveChat{display:none!important}@media(max-width:860px){.siteHeaderActions{width:100%;justify-content:center}.cartNavButton{width:100%}.cartDrawer{width:100%;padding:14px}}`}</style>
      {children}
